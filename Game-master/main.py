...
@app.route("/")
def home():
    client = MongoClient("mongodb+srv://muskan:aditi@cluster0-nvyf0.mongodb.net/tictak?retryWrites=true&w=majority")
    db = client.get_database('tictak')
    client1 = MongoClient("mongodb+srv://muskan:aditi@cluster0-nvyf0.mongodb.net/blackjack?retryWrites=true&w=majority")
...
def play1():
    ...
    if (l[1] == "X" and l[2] == "X" and l[3] == "X") or (l[4] == "X" and l[5] == "X" and l[6] == "X") or (
            l[7] == "X" and l[8] == "X" and l[9] == "X"):
        res = "Player 1 is Winner!!!"
        new1 = {'0': 'Player 1 is Winner!!!'}
        res1 = ""
        res2 = ""
        rec1.update_one({'0': 'Player 1 is X'}, {'$set': new1})
    elif (l[1] == "O" and l[2] == "O" and l[3] == "O") or (l[4] == "O" and l[5] == "O" and l[6] == "O") or (
            l[7] == "O" and l[8] == "O" and l[9] == "O"):
        res = "Player 2 is Winner!!!"
        new1 = {'0': 'Player 2 is Winner!!!'}
        res1 = ""
        res2 = ""
        rec1.update_one({'0': 'Player 1 is X'}, {'$set': new1})
    elif (l[1] == "X" and l[4] == "X" and l[7] == "X") or (l[2] == "X" and l[5] == "X" and l[8] == "X") or (
            l[3] == "X" and l[6] == "X" and l[9] == "X"):
        res = "Player 1 is Winner!!!"
        new1 = {'0': 'Player 1 is Winner!!!'}
        res1 = ""
        res2 = ""
        rec1.update_one({'0': 'Player 1 is X'}, {'$set': new1})
    elif (l[1] == "O" and l[4] == "O" and l[7] == "O") or (l[2] == "O" and l[5] == "O" and l[8] == "O") or (
            l[3] == "O" and l[6] == "O" and l[9] == "O"):
        res = "Player 2 is Winner!!!"
        new1 = {'0': 'Player 2 is Winner!!!'}
        res1 = ""
        res2 = ""
...
def play3():
    ...
    if request.method == 'POST':
        ...
        if n > chip:
            ...
            return render_template('bp.html', ph=ph, rb=rb, one=one, two="<hidden>", three=three, j=jj, k=kk, s1=s1,
                                   s2=s2)
